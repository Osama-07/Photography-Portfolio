  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "photo-gradient-hover":
          "linear-gradient(135deg, #7a5d52 0%, #c9b09e 100%)",
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      keyframes: {
        ...
        glow: {
          "0%, 100%": {
            boxShadow: "0 0 5px rgba(99, 80, 71, 0.5)",
          },
          "50%": {
            boxShadow:
              "0 0 20px rgba(99, 80, 71, 0.8), 0 0 30px rgba(181, 159, 141, 0.4)",
          },
        },
        "scroll-elegant": {
          "0%": {
